...
import ConnectButton from "../elements/ConnectButton/ConnectButton";
                ...
                <div className="flex h-19 items-center justify-between px-2 md:h-22.5 md:px-0">
                    <div className="flex items-center gap-10 md:w-full md:justify-between">
                        ...
                        <Link href='/'
                              ...
                              title={"Arcade Chain"}>
                            <picture>
                                <Image className="pt-10" src={"/images/arcade_chain.svg"} width="256" height="256" priority={true} alt="arcade chain"/>
                            </picture>
                        </Link>
                        <nav id="primary-nav"
