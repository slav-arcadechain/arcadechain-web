...
import ActHoldings from "../components/rewards/act-holdings";
      ...
      <>
        <div className="relative overflow-hidden">
          <Head>
            ...
            <meta property={"og:title"} content={"Arcade Chain - Crypto games - initial coin offering - token pre-sale"}/>
            <meta property={"og:description"} content={"Arcade Chain is crypto game platform where users can play classic and new exiting arcade games using a stable coin. Crypto initial token offering - pre-sale"}/>
